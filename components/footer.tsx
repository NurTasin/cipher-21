...
const Footer = () => {
    return (
        <footer className="bg-gray-900/40 text-green-500 border-t border-green-500 py-4">
          <div className="container mx-auto px-4 md:px-12">
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
              ...
              <div className="text-center text-sm">
                <p>Crafted by <a href="https://github.com/NurTasin" className="underline">Tasin</a></p>
              </div>
